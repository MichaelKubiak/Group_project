...
data_dir = "/home/izzy_r/Group_project/Project_repo/Group_project/testing/"
#barcode_annotation_fn <- # file.path("ADD THE BARCODE CSV HERE WHEN THOMAS HAS DONE IT!!!!!!!")


# Reference file path:
reference_fasta = file.path("/home/izzy_r/Group_project/Project_repo/Group_project/Reference_genome/ncbi/Chr38/GRCh38_latest_genomic.fna")  
reference_anno = file.path("/home/izzy_r/Group_project/Project_repo/Group_project/Reference_genome/ncbi/Chr38/Homo_sapiens.GRCh38.97.gff3") 

# breakdown file names into constituent parts for 
fastq_file1 = paste(prefix, "_1.fastq.gz", sep = "")
fq_R1 = file.path("/home/izzy_r/Group_project/Project_repo/Group_project/DATA_fastQ", fastq_file1) 

fastq_file2 = paste(prefix, "_2.fastq.gz", sep = "")
fq_R2 = file.path("/home/izzy_r/Group_project/Project_repo/Group_project/DATA_fastQ", fastq_file2)
